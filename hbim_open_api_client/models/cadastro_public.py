...
T = TypeVar("T", bound="CadastroPublic")


@_attrs_define
class CadastroPublic:
    """
    Attributes:
        id (int):
        id_edificacao (int):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        id_edificacao = self.id_edificacao
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        id_edificacao = d.pop("id_edificacao")
        ...
        cadastro_public.additional_properties = d
        return cadastro_public
