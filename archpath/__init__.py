...
class SNA_OT_Archpath_Op_Connect_19B86(bpy.types.Operator):
    ...
    def execute(self, context):
        bpy.context.scene.sna_pr_connection_status = 'Successfully connected!'
...
class SNA_PT_CADASTRAR__EDIFICAO_7C7B9(bpy.types.Panel):
    bl_label = 'Cadastrar - Edificação'
    bl_idname = 'SNA_PT_CADASTRAR__EDIFICAO_7C7B9'
    ...
    def draw(self, context):
        ...
        op = col_49DE4.operator('sn.dummy_button_operator', text='Enviar', icon_value=0, emboss=True, depress=False)


class SNA_PT_CADASTRAR__USURIO_C1058(bpy.types.Panel):
    bl_label = 'Cadastrar - Usuário'
    bl_idname = 'SNA_PT_CADASTRAR__USURIO_C1058'
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_context = ''
    bl_category = 'ArchPath'
...
class SNA_PT_CADASTRAR__CADASTRO_ARQUITETNICO_BB15B(bpy.types.Panel):
    bl_label = 'Cadastrar - Cadastro Arquitetônico'
    bl_idname = 'SNA_PT_CADASTRAR__CADASTRO_ARQUITETNICO_BB15B'
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_context = ''
    bl_category = 'ArchPath'
...
class SNA_PT_CADASTRAR__DIAGNSTICO_DANO_8609F(bpy.types.Panel):
    bl_label = 'Cadastrar - Diagnóstico Dano'
    bl_idname = 'SNA_PT_CADASTRAR__DIAGNSTICO_DANO_8609F'
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_context = ''
    bl_category = 'ArchPath'
...
class SNA_PT_CADASTRAR__GEOMETRIA_DANO_3CF06(bpy.types.Panel):
    bl_label = 'Cadastrar - Geometria Dano'
    bl_idname = 'SNA_PT_CADASTRAR__GEOMETRIA_DANO_3CF06'
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_context = ''
    bl_category = 'ArchPath'
...
class SNA_PT_INSERIR__ARQUIVO_76CE3(bpy.types.Panel):
    bl_label = 'Inserir - Arquivo'
    bl_idname = 'SNA_PT_INSERIR__ARQUIVO_76CE3'
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_context = ''
    bl_category = 'ArchPath'
...
class SNA_PT_PESQUISAR__EDIFICAO_F5723(bpy.types.Panel):
    bl_label = 'Pesquisar - Edificação'
    bl_idname = 'SNA_PT_PESQUISAR__EDIFICAO_F5723'
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_context = ''
    bl_category = 'ArchPath'
...
class SNA_PT_PESQUISAR_USURIO_C7D49(bpy.types.Panel):
    bl_label = 'Pesquisar- Usuário'
    bl_idname = 'SNA_PT_PESQUISAR_USURIO_C7D49'
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_context = ''
    bl_category = 'ArchPath'
...
class SNA_PT_PESQUISAR_CADASTRO_ARQUITETNICO_3A809(bpy.types.Panel):
    bl_label = 'Pesquisar- Cadastro Arquitetônico'
    bl_idname = 'SNA_PT_PESQUISAR_CADASTRO_ARQUITETNICO_3A809'
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_context = ''
    bl_category = 'ArchPath'
...
class SNA_PT_PESQUISAR__DIAGNSTICO_DANO_6DCEC(bpy.types.Panel):
    bl_label = 'Pesquisar - Diagnóstico Dano'
    bl_idname = 'SNA_PT_PESQUISAR__DIAGNSTICO_DANO_6DCEC'
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_context = ''
    bl_category = 'ArchPath'
...
class SNA_PT_PESQUISAR__GEOMETRIA_DANO_0DCAC(bpy.types.Panel):
    bl_label = 'Pesquisar - Geometria Dano'
    bl_idname = 'SNA_PT_PESQUISAR__GEOMETRIA_DANO_0DCAC'
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_context = ''
    bl_category = 'ArchPath'
...
class SNA_PT_DOWNLOAD__ARQUIVOS_CC99B(bpy.types.Panel):
    bl_label = 'Download - Arquivo(s)'
    bl_idname = 'SNA_PT_DOWNLOAD__ARQUIVOS_CC99B'
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_context = ''
    bl_category = 'ArchPath'
...
class SNA_PT_EXCLUIR__EDIFICAO_EE9FD(bpy.types.Panel):
    bl_label = 'Excluir - Edificação'
    bl_idname = 'SNA_PT_EXCLUIR__EDIFICAO_EE9FD'
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_context = ''
    bl_category = 'ArchPath'
...
class SNA_PT_EXCLUIR__USURIO_AA821(bpy.types.Panel):
    bl_label = 'Excluir - Usuário'
    bl_idname = 'SNA_PT_EXCLUIR__USURIO_AA821'
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_context = ''
    bl_category = 'ArchPath'
...
class SNA_PT_EXCLUIR__CADASTRO_ARQUITETNICO_84AC5(bpy.types.Panel):
    bl_label = 'Excluir - Cadastro Arquitetônico'
    bl_idname = 'SNA_PT_EXCLUIR__CADASTRO_ARQUITETNICO_84AC5'
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_context = ''
    bl_category = 'ArchPath'
...
class SNA_PT_EXCLUIR__DIAGNSTICO_DANO_7E1B6(bpy.types.Panel):
    bl_label = 'Excluir - Diagnóstico Dano'
    bl_idname = 'SNA_PT_EXCLUIR__DIAGNSTICO_DANO_7E1B6'
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_context = ''
    bl_category = 'ArchPath'
...
class SNA_PT_EXCLUIR_GEOMETRIA_DANO_EA61D(bpy.types.Panel):
    bl_label = 'Excluir- Geometria Dano'
    bl_idname = 'SNA_PT_EXCLUIR_GEOMETRIA_DANO_EA61D'
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_context = ''
    bl_category = 'ArchPath'
...
class SNA_PT_EXCLUIR__ARQUIVOS_506CB(bpy.types.Panel):
    bl_label = 'Excluir - Arquivo(s)'
    bl_idname = 'SNA_PT_EXCLUIR__ARQUIVOS_506CB'
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_context = ''
    bl_category = 'ArchPath'
...
class SNA_PT_EDITAR__EDIFICAO_CF7FA(bpy.types.Panel):
    bl_label = 'Editar - Edificação'
    bl_idname = 'SNA_PT_EDITAR__EDIFICAO_CF7FA'
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_context = ''
    bl_category = 'ArchPath'
...
class SNA_PT_EDITAR__USURIO_574AB(bpy.types.Panel):
    bl_label = 'Editar - Usuário'
    bl_idname = 'SNA_PT_EDITAR__USURIO_574AB'
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_context = ''
    bl_category = 'ArchPath'
...
class SNA_PT_EDITAR__CADASTRO_ARQUITETNICO_C13BE(bpy.types.Panel):
    bl_label = 'Editar - Cadastro Arquitetônico'
    bl_idname = 'SNA_PT_EDITAR__CADASTRO_ARQUITETNICO_C13BE'
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_context = ''
    bl_category = 'ArchPath'
...
class SNA_PT_EDITAR__DIAGNSTICO_DANO_83EB9(bpy.types.Panel):
    bl_label = 'Editar - Diagnóstico Dano'
    bl_idname = 'SNA_PT_EDITAR__DIAGNSTICO_DANO_83EB9'
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_context = ''
    bl_category = 'ArchPath'
...
class SNA_PT_EDITAR_GEOMETRIA_DANO_0D47B(bpy.types.Panel):
    bl_label = 'Editar- Geometria Dano'
    bl_idname = 'SNA_PT_EDITAR_GEOMETRIA_DANO_0D47B'
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_context = ''
    bl_category = 'ArchPath'
...
def register():
    ...
    bpy.utils.register_class(SNA_PT_CADASTRAR__EDIFICAO_7C7B9)
    bpy.utils.register_class(SNA_PT_CADASTRAR__USURIO_C1058)
    bpy.utils.register_class(SNA_PT_CADASTRAR__CADASTRO_ARQUITETNICO_BB15B)
    bpy.utils.register_class(SNA_PT_CADASTRAR__DIAGNSTICO_DANO_8609F)
    bpy.utils.register_class(SNA_PT_CADASTRAR__GEOMETRIA_DANO_3CF06)
    bpy.utils.register_class(SNA_PT_INSERIR__ARQUIVO_76CE3)
    bpy.utils.register_class(SNA_PT_PESQUISAR__EDIFICAO_F5723)
    bpy.utils.register_class(SNA_PT_PESQUISAR_USURIO_C7D49)
    bpy.utils.register_class(SNA_PT_PESQUISAR_CADASTRO_ARQUITETNICO_3A809)
    bpy.utils.register_class(SNA_PT_PESQUISAR__DIAGNSTICO_DANO_6DCEC)
    bpy.utils.register_class(SNA_PT_PESQUISAR__GEOMETRIA_DANO_0DCAC)
    bpy.utils.register_class(SNA_PT_DOWNLOAD__ARQUIVOS_CC99B)
    bpy.utils.register_class(SNA_PT_EXCLUIR__EDIFICAO_EE9FD)
    bpy.utils.register_class(SNA_PT_EXCLUIR__USURIO_AA821)
    bpy.utils.register_class(SNA_PT_EXCLUIR__CADASTRO_ARQUITETNICO_84AC5)
    bpy.utils.register_class(SNA_PT_EXCLUIR__DIAGNSTICO_DANO_7E1B6)
    bpy.utils.register_class(SNA_PT_EXCLUIR_GEOMETRIA_DANO_EA61D)
    bpy.utils.register_class(SNA_PT_EXCLUIR__ARQUIVOS_506CB)
    bpy.utils.register_class(SNA_PT_EDITAR__EDIFICAO_CF7FA)
    bpy.utils.register_class(SNA_PT_EDITAR__USURIO_574AB)
    bpy.utils.register_class(SNA_PT_EDITAR__CADASTRO_ARQUITETNICO_C13BE)
    bpy.utils.register_class(SNA_PT_EDITAR__DIAGNSTICO_DANO_83EB9)
    bpy.utils.register_class(SNA_PT_EDITAR_GEOMETRIA_DANO_0D47B)
...
def unregister():
    ...
    bpy.utils.unregister_class(SNA_PT_CADASTRAR__EDIFICAO_7C7B9)
    bpy.utils.unregister_class(SNA_PT_CADASTRAR__USURIO_C1058)
    bpy.utils.unregister_class(SNA_PT_CADASTRAR__CADASTRO_ARQUITETNICO_BB15B)
    bpy.utils.unregister_class(SNA_PT_CADASTRAR__DIAGNSTICO_DANO_8609F)
    bpy.utils.unregister_class(SNA_PT_CADASTRAR__GEOMETRIA_DANO_3CF06)
    bpy.utils.unregister_class(SNA_PT_INSERIR__ARQUIVO_76CE3)
    bpy.utils.unregister_class(SNA_PT_PESQUISAR__EDIFICAO_F5723)
    bpy.utils.unregister_class(SNA_PT_PESQUISAR_USURIO_C7D49)
    bpy.utils.unregister_class(SNA_PT_PESQUISAR_CADASTRO_ARQUITETNICO_3A809)
    bpy.utils.unregister_class(SNA_PT_PESQUISAR__DIAGNSTICO_DANO_6DCEC)
    bpy.utils.unregister_class(SNA_PT_PESQUISAR__GEOMETRIA_DANO_0DCAC)
    bpy.utils.unregister_class(SNA_PT_DOWNLOAD__ARQUIVOS_CC99B)
    bpy.utils.unregister_class(SNA_PT_EXCLUIR__EDIFICAO_EE9FD)
    bpy.utils.unregister_class(SNA_PT_EXCLUIR__USURIO_AA821)
    bpy.utils.unregister_class(SNA_PT_EXCLUIR__CADASTRO_ARQUITETNICO_84AC5)
    bpy.utils.unregister_class(SNA_PT_EXCLUIR__DIAGNSTICO_DANO_7E1B6)
    bpy.utils.unregister_class(SNA_PT_EXCLUIR_GEOMETRIA_DANO_EA61D)
    bpy.utils.unregister_class(SNA_PT_EXCLUIR__ARQUIVOS_506CB)
    bpy.utils.unregister_class(SNA_PT_EDITAR__EDIFICAO_CF7FA)
    bpy.utils.unregister_class(SNA_PT_EDITAR__USURIO_574AB)
    bpy.utils.unregister_class(SNA_PT_EDITAR__CADASTRO_ARQUITETNICO_C13BE)
    bpy.utils.unregister_class(SNA_PT_EDITAR__DIAGNSTICO_DANO_83EB9)
    bpy.utils.unregister_class(SNA_PT_EDITAR_GEOMETRIA_DANO_0D47B)
